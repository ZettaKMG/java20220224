...
public class C05Comparison {
	public static void main(String[] args) {
		...
		System.out.println(i1 >= i2);  // 왼쪽 같이 크거나 같으면 true, 아니면 false
		System.out.println(i1 < i2);  // 왼쪽 같이 작으면 true, 아니면 false
		System.out.println(i1 <= i2);  // 왼쪽 같이 작거나 같으면 true, 아니면 false
